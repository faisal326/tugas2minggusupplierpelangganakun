 ...
 * @author hp
 */
public class MasterSupplier extends javax.swing.JDialog {

    /**
     * Creates new form MasterSupplier
     */
    public MasterSupplier(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(this);
        initState();
      
       daftarSupplier.add(new Supplier("123","Faisal","Kebumen",
               "087737644494","Faisal"));
    }
    ...
    private void initComponents() {
        ...
        tblsupplier.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Kode", "Nama", "Alamat", "Telphone", "Nama Kontak"
            }
        ));
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(txtnamakontak, javax.swing.GroupLayout.PREFERRED_SIZE, 175, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(layout.createSequentialGroup()
    ...
    supplier.setNotelp(txttelp.getText());
    supplier.setNamakontak(txtnamakontak.getText());
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                MasterSupplier dialog = new MasterSupplier(new javax.swing.JFrame(), true);
    ...
    private void initState(){
        ...
        tblsupplier.setModel(new SupplierTableModel(daftarSupplier));
