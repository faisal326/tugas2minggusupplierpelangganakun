...
public class MasterAkun extends javax.swing.JDialog {
    ...
    public MasterAkun(java.awt.Frame parent, boolean modal) {
        ...
        initState();
      daftarAkun.add(new Akun("Faisal","Faisal SA","Faisalsa326","Admin"));
    ...
    private void initComponents() {
        ...
        cmbstatus.addContainerListener(new java.awt.event.ContainerAdapter() {
            public void componentAdded(java.awt.event.ContainerEvent evt) {
                cmbstatusComponentAdded(evt);
            }
        });
    ...
    tblakun.setModel(new AkunTabelModel(daftarAkun));
    }
